...
```bash
curl https://ai-gateway.sassmaker.com/v1/videos/generations \
...
```js
const res = await fetch('https://ai-gateway.sassmaker.com/v1/videos/generations', {
  method: 'POST',
  headers: {
...
```js
const BASE = 'https://ai-gateway.sassmaker.com';
